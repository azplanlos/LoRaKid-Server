...
public class LoRaKidPush implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    public APIGatewayV2HTTPResponse handleRequest(APIGatewayV2HTTPEvent event, Context context) {
        ...
        try {
            ...
            logger.log(message.getUplinkMessage().getDecodedPayload().toString());
            client.sendMessage(System.getenv("PUSHOVER_USER_TOKEN"), message.getUplinkMessage().getDecodedPayload().toString());
